...
public:
    ...
    void init(JSON* architecture_obj){
        ...
        for (int l=0;l<architecture_obj->array.size();++l){
            ...
            else if (0==type.compare("SceneHolisticOnlineTSDF"))            pLayer = new SceneHolisticOnlineTSDFLayer(p);
            else if (0==type.compare("SceneHolisticOnlineTSDFROI"))         pLayer = new SceneHolisticOnlineTSDFROILayer(p);
            else if (0==type.compare("SceneHolisticOnlineTSDFSimple"))         pLayer = new SceneHolisticOnlineTSDFSimpleLayer(p);
            else if (0==type.compare("SceneHolisticOnlineTSDFSimpleReg"))         pLayer = new SceneHolisticOnlineTSDFSimpleRegLayer(p);
